  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        setError(
          "⚠️ Backend Connection Error. Please ensure the backend is running.",
        );
      } finally {
        setLoading(false);
      }
              ...
              .map((product, index) => (
                ...
                >
                  <div className="relative aspect-square m-3 rounded-md overflow-hidden bg-white flex items-center justify-center">
                    ...
                    {!product.stock && (
                      <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                        <span className="bg-white text-black px-4 py-2 font-black text-[10px] uppercase tracking-[0.2em] rounded-sm">
                          Sold Out
                        </span>
                      </div>
                    )}
                  ...
                  <div className="p-4 sm:p-6 flex-1 flex flex-col">
                    ...
                    <h3 className="text-sm font-black text-gray-900 mb-2 line-clamp-1">
                      {product.title}
                    </h3>
                    {/* Mobile Stock Tag */}
