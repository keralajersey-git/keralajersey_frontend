...
import { FiPlus, FiEdit2, FiTrash2, FiImage, FiX, FiCheck, FiUploadCloud } from 'react-icons/fi';
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-12">
                    <div>
                        ...
                        <p className="text-gray-500 text-sm font-medium mt-1 uppercase tracking-widest">
                            Manage your premium collections
                        </p>
                    </div>
                    <button
                        onClick={() => {
                        ...
                        className="w-full sm:w-auto flex items-center justify-center gap-2 bg-gray-900 text-white px-6 py-3 rounded-xl font-bold hover:bg-black transition-all shadow-lg shadow-gray-900/20 active:scale-95"
                    >
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-1 gap-6 md:hidden">
                            {products.map((product) => (
                                <div key={product.$id || product.id} className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 space-y-4">
                                    <div className="flex items-center gap-4">
                                        <img
                                            src={product.image1}
                                            alt={product.title}
                                            className="w-20 h-20 rounded-xl object-cover bg-gray-100 border border-gray-50"
                                        />
                                    ...
                                    <div className="flex gap-3 pt-2">
                                        <button
                                            onClick={() => handleEdit(product)}
                                            className="flex-1 flex items-center justify-center gap-2 py-3 bg-blue-50 text-blue-600 rounded-xl font-bold"
                                        >
                                            <FiEdit2 className="w-4 h-4" />
                                            Edit
                                        </button>
                                        <button
                                            onClick={() => handleDelete(product.$id || product.id)}
                                            className="flex-1 flex items-center justify-center gap-2 py-3 bg-red-50 text-red-600 rounded-xl font-bold"
                                        >
                                            <FiTrash2 className="w-4 h-4" />
                                            Delete
                                        </button>
                            ...
                            <div className="p-6 sm:p-8">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            ...
                                            <select
                                                ...
                                                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-gray-900 focus:ring-0 outline-none transition-all appearance-none bg-white"
                                            >
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {['S', 'M', 'L', 'XL', 'XXL', 'XXXL'].map(size => (
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-lg text-xs font-bold transition-all border-2 ${formData.available_sizes.includes(size) ? 'bg-gray-900 border-gray-900 text-white' : 'border-gray-200 text-gray-400 hover:border-gray-300'}`}
                                                >
                                                    {size}
                                                </button>
                                            ))}
                                    ...
                                    <div className="space-y-6 pt-4 border-t border-gray-100">
                                        ...
                                        {[1, 2, 3].map((num) => (
                                            <div key={`img-upload-box-${num}`} className="bg-gray-50/50 p-4 rounded-3xl border border-gray-100">
                                                <div className="flex gap-4 items-center">
                                                    {/* Better Preview Area */}
                                                    <div className="relative w-20 h-20 bg-white rounded-2xl border-2 border-dashed border-gray-200 flex items-center justify-center overflow-hidden shrink-0 group">
                                                    ...
                                                    <div className="flex-1 space-y-3">
                                                        ...
                                                        <div className="flex gap-2">
                                                            <input
                                                                ...
                                                                className="flex-1 px-4 py-2.5 text-sm rounded-xl border border-gray-200 focus:border-gray-900 focus:ring-0 outline-none transition-all placeholder:text-gray-300 bg-white"
                                                                placeholder="Paste URL..."
                                                                disabled={formData[`image${num}`] === 'Uploading...'}
                                                            />

                                                            <label
                                                                className={`w-11 h-11 flex items-center justify-center rounded-xl cursor-pointer transition-all active:scale-90 ${formData[`image${num}`] === 'Uploading...' ? 'bg-gray-100 text-gray-400 cursor-wait' : 'bg-gray-900 text-white hover:bg-black shadow-lg shadow-gray-900/20'}`}
                                                            >
                                    ...
                                    <div className="pt-8">
                                        <button
                                            disabled={isSubmitting}
                                            type="submit"
                                            className="w-full bg-gray-900 text-white py-4.5 rounded-2xl font-black uppercase tracking-[0.2em] hover:bg-black transition-all disabled:opacity-50 shadow-xl shadow-gray-900/30 active:scale-[0.98] flex items-center justify-center gap-3"
                                        >
                                            {isSubmitting ? (
                                                <>
